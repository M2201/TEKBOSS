...
const STATIC_QUESTIONS = [
  ...
  { id: 6, phase: 'Story', text: 'If the next 12 months go exactly the way you want — what does that actually look like?', hint: 'Think in specifics — clients, revenue, team size, what your week looks like.', example: '30 retainer clients, team of 4, $50k/month in revenue, and referrals filling the pipeline with no cold outreach.' },
  { id: 7, phase: 'Operations', text: 'Walk me through a typical week. Where does your time actually go?', hint: 'Break it down by activity — meetings, client delivery, admin, sales.', example: 'Mon: strategy calls. Tue–Wed: client work. Thu: sales. Fri: admin and invoicing. About 70% is billable.' },
  ...
  { id: 16, phase: 'AI Experience', text: "What tools or platforms are completely off the table — things your team won't give up no matter what?", hint: 'These are your non-negotiables — what any recommendation needs to work around.', example: 'HubSpot, Slack, and Google Workspace — the team won\'t move off these.' },
