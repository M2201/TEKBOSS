          ...
          <div id="learn-more" className="max-w-2xl mx-auto px-6 pb-8">
            <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 text-left">
              ...
              <ul className="space-y-3 text-sm text-slate-400 font-medium">
                <li className="flex items-start gap-3"><CheckCircle size={14} className="text-blue-500 shrink-0 mt-0.5" /> <span><strong className="text-white">24 questions</strong> asked one at a time, conversational format</span></li>
